...
const userFormInitialValue = { email: '', password: '' }

const Login: React.FC = () => {
    const { login, user, isLoggedIn } = useAuth();
    const [credentials, setCredentials] = useState(userFormInitialValue);
    ...
    return (
        <div className="container">
            <div className="card">
                <h1 className="card_title">Contact us</h1>
                <form className="card_form" onSubmit={handleSubmit} >
                    <div className="input">
                        <input name="email" type="text" className="input_field" required={true} onChange={(e) => handleChange(e)} />
                        <label className="input_label">Email</label>
                    </div>
                    <div className="input">
                        <input name="password" type="password" className="input_field" required={true} onChange={(e) => handleChange(e)} />
                        <label className="input_label">Password</label>
                    </div>
                    <button className="card_button">Login</button>
                </form>
            ...
            <div className="fish-shadow-con">
                <svg className="fish-shadow" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMin slice" viewBox="0 0 743 645">
                    ...
                    <g id="Artboard" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="square">
                        <path d="M177.367 337.568L182.709 357.739C198.517 417.421 249.748 460.995 311.193 467.019L421.508 477.834C478.237 483.396 532.831 454.649 560.346 404.729C607.09 319.923 557.549 214.182 462.47 195.822L375.079 178.946C368.369 177.651 361.766 175.854 355.324 173.572C251.651 136.837 149.205 231.245 177.367 337.568Z" className="line" id="Line"></path>
                        ...
                        <g xmlns="http://www.w3.org/2000/svg" id="Artboard" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g id="Group" transform="translate(-103.000000, 3.000000)" fill="#F2AFAF">
                                <g id="l-1" transform="translate(118.396084, 37.985234) rotate(-89.000000) translate(-118.396084, -37.985234) translate(104.396084, 23.985234)">
                                    <path d="M14.1723611,27.5145257 C19.9713509,27.5145257 24.6723611,22.8135155 24.6723611,17.0145257 C24.6723611,15.8258883 28.1981217,2.09701504 27.8341336,1.03166708 C26.4223375,-3.10048431 18.7827136,6.51452565 14.1723611,6.51452565 C9.87015746,6.51452565 1.67467528,-2.67194974 0.0523652038,1.03166708 C-0.512055182,2.32019808 3.67236107,15.5177394 3.67236107,17.0145257 C3.67236107,22.8135155 8.3733712,27.5145257 14.1723611,27.5145257 Z"></path>
                                </g>
                            </g>
                            <animateMotion dur="6s" begin="0s" repeatCount="indefinite" rotate="auto" fill="freeze">
                                <mpath xlinkHref="#Line"></mpath>
                            </animateMotion>
                        </g>
